import "../styles/informationMovil.css";

export const InformationMovil = () => {
  return (
    <div className="card">
      <div className="card__content">
        ...
        <p className="card__description">
          ...
          experiencia en la creación de páginas web excepcionales. Con más de 2
          años de experiencia en el campo, me especializo en convertir diseños
          creativos en interfaces interactivas y funcionales. Estoy
