...
export const Contact = () => {
  return (
    <div className="content-conctact ">
      ...
      <div className="card-icon-contact">
        ...
        >
          ...
          <p className="name-contact-social">Instagram</p>
        </a>
        ...
        >
          ...
          <p className="name-contact-social">LinkedIn</p>
        </a>
        <a
        ...
        >
          ...
          <p className="name-contact-social">GitHub</p>
        </a>
        <a
